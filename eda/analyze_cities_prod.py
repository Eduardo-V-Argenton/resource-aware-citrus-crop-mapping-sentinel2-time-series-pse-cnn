...
producao_merged = producao_merged[producao_merged["area_ha"] < 3.5e+05]
ranking_regioes = producao_merged.sort_values(by='media_anual_regiao', ascending=False).reset_index(drop=True)
